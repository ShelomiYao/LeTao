...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray *hotSeaches = @[@"肉松饼", @"平原柑橘", @"大浦柚子", @"兴宁龙眼", @"年货大集", @"酸奶", @"腌面", @"纸巾", @"水", @"车厘子", @"草莓", @"洽洽瓜子", @"维他奶", @"香烟",  @"星巴克"];
    // 2. Create a search view controller
    PYSearchViewController *searchViewController = [PYSearchViewController searchViewControllerWithHotSearches:hotSeaches searchBarPlaceholder:NSLocalizedString(@"请输入商品的名称", @"") didSearchBlock:^(PYSearchViewController *searchViewController, UISearchBar *searchBar, NSString *searchText) {
